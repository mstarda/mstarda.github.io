...
if (window.matchMedia && window.matchMedia('(prefers-color-scheme: light)').matches) {
  ...
  element.src="https://media.discordapp.net/attachments/701101100614549694/868176703271358485/Adsz-removebg-preview.png?width=349&height=165g";
}
...
themeBtn.onclick = function toggleTheme() {
  ...
  if (document.body.classList.contains("dark")) {
    element = document.getElementById("bolby-logo-theme");
    element.src="https://media.discordapp.net/attachments/701101100614549694/868176703271358485/Adsz-removebg-preview.png?width=349&height=165";
  }
  else {
    element = document.getElementById("bolby-logo-theme");
    element.src="https://media.discordapp.net/attachments/701101100614549694/868176703271358485/Adsz-removebg-preview.png?width=349&height=165";
